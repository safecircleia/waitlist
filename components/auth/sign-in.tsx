      ...
      <CardContent>
        <div className="grid gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              onClick={async () => {
                await signIn.email(
                {
                    email,
                    password,
                    callbackURL: "/waitlist" // Redirect to waitlist page after authentication
                },
                {
                  onRequest: (ctx) => {
                    setLoading(true);
          ...
          <Button
              ...
              await signIn.passkey(
                {
                  callbackURL: "/waitlist" // Stay on homepage after authentication
                },
                {
                  onRequest: (ctx) => {
                    setLoading(true);
        ...
        <Button
                  ...
                  onClick={async () => {
                    ...
                    {
                      provider: "google",
                      callbackURL: "/waitlist" // Stay on the homepage after auth
                    },
                    {
                      onRequest: (ctx) => {
                         setLoading(true);
